...
Contains individual sales order records.
...
Contains current inventory levels for each product.
...
Contains customer demographic and registration data.
...
Contains individual order line items with product details.
...
Contains product return records.
...
Contains store location and metadata.
...
Contains aggregated monthly revenue figures.
